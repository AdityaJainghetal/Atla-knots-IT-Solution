    ...
    <div className={`min-h-screen transition-colors duration-700
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-20">
        ...
        <div className="prose prose-invert max-w-none text-[15.8px] leading-relaxed space-y-12">
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>1. Information We Collect</h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div className={`p-7 rounded-2xl ${cardClass}`}>
                <h3 className={`text-xl font-medium mb-4 ${headingClass}`}>Personal Information</h3>
              ...
              <div className={`p-7 rounded-2xl ${cardClass}`}>
                <h3 className={`text-xl font-medium mb-4 ${headingClass}`}>Technical Information</h3>
                <ul className={`space-y-3 ${bodyClass}`}>
                  <li className="flex gap-3"><span className="text-red-500 mt-1">•</span> IP address, browser type, device, and operating system</li>
                  <li className="flex gap-3"><span className="text-red-500 mt-1">•</span> Website usage data, pages visited, and session duration</li>
                  <li className="flex gap-3"><span className="text-red-500 mt-1">•</span> Cookies and similar tracking technologies</li>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>2. How We Use Your Information</h2>
            <p className={`mb-5 ${bodyClass}`}>We use your data to deliver excellent service and improve your experience:</p>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>3. Data Sharing & Third Parties</h2>
            <p className={bodyClass}>We do not sell your personal data. We may share information only with:</p>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>4. Your Rights (DPDP Act, 2023)</h2>
            <p className={`mb-6 ${bodyClass}`}>As per the Digital Personal Data Protection Act, you have the right to:</p>
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                "Access and obtain a copy of your personal data",
                "Correct inaccurate or incomplete data",
                ...
                <div key={i} className={`p-5 rounded-xl flex items-start gap-3 ${cardClass}`}>
                  <span className="text-red-400 text-xl">✓</span>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>5. Data Security & Retention</h2>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>6. Cookies</h2>
            <p className={bodyClass}>
              Our website uses cookies to improve functionality and analyze traffic. You can manage your cookie preferences through your browser settings at any time.
            </p>
          </section>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>7. Changes to This Policy</h2>
            <p className={bodyClass}>
              We may update this Privacy Policy occasionally. Any changes will be posted on this page with the updated date. We encourage you to review it periodically.
            </p>
          </section>     
          ...
          <div className={`p-8 md:p-10 rounded-3xl mt-12 ${cardClass} border ${isDark ? "border-red-900/30" : "border-red-200"}`}>
            ...
            <p className={`mb-6 ${bodyClass}`}>If you have any questions about this Privacy Policy, please feel free to contact us.</p>
