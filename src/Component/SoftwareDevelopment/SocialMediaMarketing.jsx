...
//             className={`text-4xl md:text-6xl font-black text-center mb-16 ${headingClass}`}
//           >
//             Advantages of <span className={accentClass}>Atla Knots IT Solutions</span>
//           </motion.h2>
...
//           >
//             Why Bhopal Businesses Choose <span className={accentClass}>Atla Knots IT Solutions</span>
//           </motion.h2>
...
//             className={`text-4xl md:text-6xl font-black mb-8 ${headingClass}`}
//           >
//             Let’s Grow Your Business with <span className={accentClass}>Atla Knots</span>
//           </motion.h2>
...
const images = {
  ...
  growth: "https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=2340&q=80",
};
    ...
    <div className={`min-h-screen overflow-hidden transition-colors duration-700
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-400 via-red-500 to-white">Bhopal</span>
          </motion.h1>
          ...
          >
            At <span className="font-semibold text-red-400">Atla Knots IT Solutions</span>, we are one of the most trusted Social Media Marketing agencies in Bhopal. 
            We create powerful strategies that deliver actual results — more followers, better engagement, and quality leads.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {platforms.map((plat, idx) => (
              ...
              >
                <plat.icon className={`w-16 h-16 mb-8 mx-auto transition-transform group-hover:scale-110 ${accentClass}`} />
                <h3 className={`text-2xl font-bold mb-6 text-center ${headingClass}`}>{plat.title}</h3>
                <p className={`text-center leading-relaxed ${bodyClass}`}>{plat.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {advantages.map((adv, idx) => (
              <motion.div
                ...
                className={`rounded-3xl p-10 transition-all group ${cardClass}`}
              >
                <adv.icon className={`w-16 h-16 mb-8 mx-auto transition-transform group-hover:scale-110 ${accentClass}`} />
                <h3 className={`text-2xl font-bold mb-6 text-center ${headingClass}`}>{adv.title}</h3>
                <p className={`text-center leading-relaxed ${bodyClass}`}>{adv.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-20">
            {whyChoose.map((point, idx) => (
              ...
              >
                <CheckCircle2 className={`w-8 h-8 mt-1 flex-shrink-0 ${accentClass}`} />
          ...
          {/* Areas We Serve */}
          <motion.h3 className={`text-3xl font-bold text-center mb-10 ${headingClass}`}>
            Areas We Serve in <span className={accentClass}>Bhopal</span>
          </motion.h3>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  <span className={`text-xl font-bold ${headingClass}`}>{faq.q}</span>
                  <span className={`text-2xl text-red-500 transition-transform ${openFaq === idx ? "rotate-180" : ""}`}>▼</span>
                </button>
                {openFaq === idx && (
                  <div className={`px-8 pb-8 text-lg ${bodyClass}`}>{faq.a}</div>
                )}
              </motion.div>
            ))}
          </div>
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-black" : "bg-gray-50"}`}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Let Atla Knots IT Solutions help you build a powerful social media presence in Bhopal and beyond.
          </motion.p>
          ...
          <p className={`mt-10 text-lg ${isDark ? "text-gray-400" : "text-gray-600"}`}>
            📞 +91 78696 36070 &nbsp; | &nbsp; support@atlaknots.com
          </p>
        </div>
      </section>
