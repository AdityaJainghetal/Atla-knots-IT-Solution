    ...
    <div className={`relative ${t.bg} overflow-hidden transition-colors duration-300`}>
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${t.sectionBg5} transition-colors duration-300`}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Transform your business with smart technology. Partner with Atla Knots IT Solutions for reliable and result-driven AI & Machine Learning Services in Bhopal.
          </motion.p>
          <motion.button
