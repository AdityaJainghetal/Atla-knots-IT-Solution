    ...
    >
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        >
          ...
          >
            Partner with <span className="font-semibold text-red-400">Atla Knots IT Solutions</span>, 
            one of India’s trusted digital marketing companies. We help businesses 
            increase their online presence, reach the right audience, and generate quality leads 
            through smart, result-driven digital marketing campaigns.
          </motion.p>
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-gray-950" : "bg-gray-50"}`}>
        <div className="max-w-7xl mx-auto">
          ...
          >
            At Atla Knots IT Solutions, we create customized digital marketing strategies 
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-black" : "bg-white"}`}>
        <div className="max-w-7xl mx-auto">
          ...
          >
            Reliable and result-driven digital marketing services tailored to your business goals.
          </motion.p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              ...
              >
                <service.icon className={`w-16 h-16 mb-8 mx-auto transition-transform group-hover:scale-110 ${accentClass}`} />
                <h3 className={`text-2xl font-bold mb-6 text-center ${headingClass}`}>
                  {service.title}
                </h3>
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-gray-950" : "bg-white"}`}>
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              At Atla Knots IT Solutions, we believe every business has the potential to grow online 
              with the right strategy. Contact us today and start your digital growth journey.
            </motion.p>
