    ...
    <div className={`min-h-screen transition-colors duration-700
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-20">
        ...
        <div className="prose prose-invert max-w-none text-[15.8px] leading-relaxed space-y-12">
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>1. What Are Cookies?</h2>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>2. Types of Cookies We Use</h2>
            
            <div className="space-y-8">
              <div className={`p-7 rounded-2xl ${cardClass}`}>
                <h3 className={`text-xl font-medium mb-3 ${headingClass}`}>Essential Cookies</h3>
                <p className={bodyClass}>
                  These cookies are necessary for the website to function properly. They enable core functionalities like page navigation, 
                  security, and access to secure areas. You cannot opt-out of these cookies.
                </p>
              ...
              <div className={`p-7 rounded-2xl ${cardClass}`}>
                <h3 className={`text-xl font-medium mb-3 ${headingClass}`}>Performance & Analytics Cookies</h3>
                <p className={bodyClass}>
                  These cookies help us understand how visitors interact with our website. We use tools like Google Analytics to collect 
                  information such as pages visited, time spent, and bounce rates. This helps us improve our website and services.
                </p>
              ...
              <div className={`p-7 rounded-2xl ${cardClass}`}>
                <h3 className={`text-xl font-medium mb-3 ${headingClass}`}>Functional Cookies</h3>
                <p className={bodyClass}>
                  These cookies allow the website to remember your choices (such as language preference or region) and provide enhanced, 
                  personalized features.
                </p>
              ...
              <div className={`p-7 rounded-2xl ${cardClass}`}>
                <h3 className={`text-xl font-medium mb-3 ${headingClass}`}>Marketing & Advertising Cookies</h3>
                <p className={bodyClass}>
                  These cookies are used to deliver relevant advertisements and track the effectiveness of our marketing campaigns. 
                  They may also be used by third-party advertising networks.
                </p>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>3. Third-Party Cookies</h2>
            <p className={bodyClass}>
              We may use third-party services (such as Google Analytics, Facebook Pixel, or payment gateways) that set their own cookies 
              when you visit our website. These cookies are governed by the respective third parties' privacy policies.
            </p>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>4. How to Manage Cookies</h2>
            <p className={`mb-6 ${bodyClass}`}>You can control and manage cookies in several ways:</p>
            
            <div className={`p-7 md:p-10 rounded-3xl ${cardClass}`}>
              <ul className={`list-disc pl-6 space-y-4 ${bodyClass}`}>
                <li><strong>Browser Settings:</strong> Most browsers allow you to block or delete cookies. Please note that disabling essential cookies may affect the functionality of our website.</li>
                <li><strong>Cookie Consent Banner:</strong> When you first visit our website, you will see a cookie consent banner where you can accept or customize your preferences.</li>
                <li><strong>Opt-out Options:</strong> You can opt-out of analytics and marketing cookies through the consent manager.</li>
              </ul>
            </div>
          </section>

          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>5. Updates to This Cookie Policy</h2>
            <p className={bodyClass}>
              We may update this Cookie Policy from time to time to reflect changes in our practices or legal requirements. 
              Any updates will be posted on this page with the revised "Last updated" date. We encourage you to review this page periodically.
            </p>
          ...
          <section>
            <h2 className={`text-3xl font-semibold mb-5 ${headingClass}`}>6. Contact Us</h2>
            <p className={`mb-6 ${bodyClass}`}>
              If you have any questions about our use of cookies or this Cookie Policy, please feel free to contact us:
            </p>

            <div className={`p-8 md:p-10 rounded-3xl ${cardClass} border ${isDark ? "border-red-900/30" : "border-red-200"}`}>
              <div className="flex flex-col sm:flex-row gap-8 text-sm">
                <div>
                  <p className="text-gray-400">Email</p>
