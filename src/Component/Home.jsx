...
// //   // ====================== FAQ Accordion Item Component ======================
// // // Place this inside your Home() function, before the return statement
...
// //             {[
// //               {
// //                 q: "What services does ATLA KNOTS provide?",
...
//       <section className={`py-20 px-6 md:px-12 lg:px-24 ${isDark ? "bg-gray-950" : "bg-white"}`}>
...
//             variants={fadeInUp}
//           >
//             <h2 className={`text-5xl md:text-6xl font-bold mb-6 ${headingClass}`}>
//               Explore Our <span className="text-red-500">Portfolio</span>
//             </h2>
//             <p className={`text-xl max-w-2xl mx-auto mb-10 ${bodyClass}`}>
//               Discover our latest projects in web development, digital marketing, 
//               and IT solutions that have delivered real results for our clients.
//             </p>
