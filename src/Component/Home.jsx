...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen overflow-x-hidden transition-colors duration-700
      ...
      <section className={`relative min-h-screen flex items-center justify-center px-6 md:px-12 lg:px-24 overflow-hidden
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <motion.div variants={isDark ? fadeInUp : {}} className="flex flex-col sm:flex-row gap-6 justify-center">
              <button 
      ...
      {/* ====================== SERVICES SECTION ====================== */}
      <section className={`py-24 px-6 md:px-12 lg:px-24 transition-colors
        ...
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            variants={fadeInUp}
            className={`text-5xl md:text-6xl font-bold text-center mb-6 ${isDark ? "" : "text-gray-900"}`}
          >
            OUR <span className={isDark ? "text-red-500" : "text-blue-600"}>SERVICES</span>
          </motion.h2>
          ...
          <div className="space-y-20">
            {/* IT Services */}
            <div>
              <h3 className={`text-4xl md:text-5xl font-bold mb-8 text-center tracking-tight 
                ${isDark ? "text-red-400" : "text-blue-700"}`}>
                1. Information Technology Services
              </h3>
              <p className={`text-lg md:text-xl mb-12 text-center max-w-4xl mx-auto leading-relaxed 
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                <motion.div
                  ...
                  variants={fadeInUp}
                  className={`bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full
                    ${isDark ? "" : "bg-white border-gray-200 shadow-sm text-gray-900"}`}
                >
                  <Code className={`w-12 h-12 md:w-14 md:h-14 mb-6 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                  <h4 className={`text-xl md:text-2xl font-bold mb-5 ${isDark ? "text-white" : "text-gray-900"}`}>Development</h4>
                  <ul className={`text-sm md:text-base w-full max-w-xs space-y-3 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                    <li>• Web application development</li>
                    <li>• Mobile application development</li>
                    <li>• Secure, scalable & user-friendly solutions</li>
                  </ul>
                ...
                <motion.div
                  ...
                  className={`bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full
                    ${isDark ? "" : "bg-white border-gray-200 shadow-sm text-gray-900"}`}
                >
                  <ShieldCheck className={`w-12 h-12 md:w-14 md:h-14 mb-6 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                  <h4 className={`text-xl md:text-2xl font-bold mb-5 ${isDark ? "text-gray-900" : "text-gray-900"}`}>Testing</h4>
                  <ul className={`text-sm md:text-base w-full max-w-xs space-y-3 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                    <li>• Web application testing</li>
                    <li>• Mobile application testing</li>
                    <li>• Quality, performance & security assurance</li>
                ...
                <motion.div
                  ...
                  className={`bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full
                    ${isDark ? "" : "bg-white border-gray-200 shadow-sm text-gray-900"}`}
                >
                  <Users className={`w-12 h-12 md:w-14 md:h-14 mb-6 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                  <h4 className={`text-xl md:text-2xl font-bold mb-5 ${isDark ? "text-white" : "text-gray-900"}`}>L2 Support</h4>
                  <p className={`text-sm md:text-base leading-relaxed max-w-xs ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                    Advanced troubleshooting, in-depth diagnosis & root cause resolution for complex issues.
                  </p>
                </motion.div>
                ...
                <motion.div
                  ...
                  className={`bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full
                    ${isDark ? "" : "bg-white border-gray-200 shadow-sm text-gray-900"}`}
                >
                  <Server className={`w-12 h-12 md:w-14 md:h-14 mb-6 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                  <h4 className={`text-xl md:text-2xl font-bold mb-5 ${isDark ? "text-white" : "text-gray-900"}`}>Product Assistance</h4>
                  <ul className={`text-sm md:text-base w-full max-w-xs space-y-3 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                    <li>• Continuous support & maintenance</li>
                    <li>• Ticket & incident management</li>
                    <li>• Change management & SLA tracking</li>
            ...
            <div>
              ...
              <p className={`text-lg md:text-xl mb-12 text-center max-w-3xl mx-auto leading-relaxed 
                ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                Streamline operations and enhance customer engagement with reliable, scalable support.
              </p>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                <motion.div
                  ...
                  className={`bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full
                    ${isDark ? "" : "bg-white border-gray-200 shadow-sm text-gray-900"}`}
                >
                  <Headphones className={`w-12 h-12 md:w-14 md:h-14 mb-6 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                  <h4 className={`text-xl md:text-2xl font-bold mb-5 ${isDark ? "text-white" : "text-gray-900"}`}>Voice, Chat & Email</h4>
                  <ul className={`text-sm md:text-base w-full max-w-xs space-y-3 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                    <li>• Inbound & outbound voice support</li>
                    <li>• Real-time chat assistance</li>
                    <li>• Structured email & ticketing</li>
                ...
                <motion.div
                  ...
                  className={`bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full
                    ${isDark ? "" : "bg-white border-gray-200 shadow-sm text-gray-900"}`}
                >
                  <BarChart3 className={`w-12 h-12 md:w-14 md:h-14 mb-6 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                  <h4 className={`text-xl md:text-2xl font-bold mb-5 ${isDark ? "text-white" : "text-gray-900"}`}>Cataloguing & Enrichment</h4>
                  <ul className={`text-sm md:text-base w-full max-w-xs space-y-3 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                    <li>• Product descriptions, tags & keywords</li>
                    <li>• Data validation & cleaning</li>
                    <li>• Category & attribute enrichment</li>
                ...
                <motion.div
                  ...
                  className={`bg-gray-900/60 backdrop-blur-sm border border-gray-800 rounded-2xl p-6 md:p-8 flex flex-col items-center text-center h-full
                    ${isDark ? "" : "bg-white border-gray-200 shadow-sm text-gray-900"}`}
                >
                  <CheckCircle className={`w-12 h-12 md:w-14 md:h-14 mb-6 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                  <h4 className={`text-xl md:text-2xl font-bold mb-5 ${isDark ? "text-white" : "text-gray-900"}`}>Quality Assurance</h4>
                  <p className={`text-sm md:text-base leading-relaxed max-w-xs ${isDark ? "text-gray-300" : "text-gray-600"}`}>
                    Call/chat audits, SOP/SLA compliance, feedback, coaching & continuous improvement.
                  </p>
                </motion.div>
      ...
      {/* ====================== WHY CHOOSE US ====================== */}
      <section className={`relative py-24 px-6 md:px-12 lg:px-24 ${isDark ? "bg-black" : "bg-white"}`}>
        <div className="max-w-7xl mx-auto">
          <motion.h2
            initial={isDark ? "hidden" : false}
            whileInView={isDark ? "visible" : false}
          ...
          >
            WHY <span className={isDark ? "text-red-500" : "text-blue-600"}>CHOOSE US</span>
          </motion.h2>
            ...
            {[
              ...
              >
                <div className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-8 mx-auto
                  ...
                  <item.icon className={`w-10 h-10 ${isDark ? "text-red-500" : "text-blue-600"}`} />
                </div>
