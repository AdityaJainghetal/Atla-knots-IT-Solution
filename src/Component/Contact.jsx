...
// //   return (
// //     <div
// //       className={`relative min-h-screen ${isDark ? "bg-black text-gray-100" : "bg-white text-gray-900"} overflow-hidden`}
// //     >
...
// //           <div
// //             className={`absolute inset-0 ${isDark ? "bg-gradient-to-br from-black/70 via-red-950/25 to-red-900/10" : "bg-gradient-to-br from-white/70 via-blue-50/25 to-blue-100/10"} pointer-events-none`}
// //           />
...
// //               <motion.p
// //                 variants={itemVariants}
// //                 className={`mt-5 text-lg md:text-xl ${isDark ? "text-gray-300" : "text-gray-700"} max-w-3xl mx-auto`}
// //               >
...
// //         {/* Main Content */}
// //         <section
// //           className={`py-12 md:py-20 border-t ${isDark ? "border-gray-800 bg-black/50" : "border-gray-200 bg-white/50"} backdrop-blur-sm`}
// //         >
...
// //               >
// //                 <h2
// //                   className={`text-3xl md:text-4xl font-bold ${isDark ? "text-white" : "text-gray-900"} mb-8`}
// //                 >
// //                   Contact Information
// //                 </h2>
...
// //                       </h3>
// //                       <p
// //                         className={`mt-1.5 ${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed`}
// //                       >
// //                         103, Goyal Vihar,
// //                         <br />
// //                         Plot No 31-C, Zone 2,
...
// //                 >
// //                   <h2
// //                     className={`text-2xl md:text-3xl font-bold ${isDark ? "text-white" : "text-gray-900"} mb-7`}
// //                   >
// //                     Send Us a Message
// //                   </h2>
...
// //                         required
// //                         disabled={loading}
// //                         className={`w-full px-4 py-3.5 ${isDark ? "bg-gray-900/60 border-gray-700 text-white placeholder-gray-500" : "bg-gray-50 border-gray-300 text-gray-900 placeholder-gray-400"} border rounded-lg focus:border-red-500 focus:outline-none disabled:opacity-60 transition`}
// //                       />
// //                       <input
// //                         type="email"
// //                         name="email"
...
//             ${isDark 
//               ? "bg-gradient-to-br from-black/70 via-red-950/25 to-red-900/10" 
//               : "bg-gradient-to-br from-white/70 via-blue-50/25 to-blue-100/10"}`} 
//           />
...
//               <motion.h1
//                 variants={itemVariants}
//                 className={`text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight ${isDark ? "text-white" : "text-gray-900"}`}
//               >
//                 <span className="bg-gradient-to-r from-red-500 via-red-400 to-rose-500 bg-clip-text text-transparent">
//                   Get in Touch
//                 </span>
...
//               <motion.p
//                 variants={itemVariants}
//                 className={`mt-5 text-lg md:text-xl max-w-3xl mx-auto ${isDark ? "text-gray-300" : "text-gray-700"}`}
//               >
//                 Have questions or ready to start a project? We're here to help.
//               </motion.p>
//             </motion.div>
...
//         {/* Main Content */}
//         <section className={`py-12 md:py-20 border-t transition-colors
...
//                 <div className="space-y-7">
//                   <div className="flex items-start gap-4">
//                     <div className={`p-3.5 rounded-xl ${isDark ? "bg-red-900/25 border border-red-800/40" : "bg-red-100 border border-red-200"}`}>
//                       <Building2 className={`h-6 w-6 ${isDark ? "text-red-500" : "text-red-600"}`} />
//                     </div>
//                     <div>
//                       <h3 className={`text-lg font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>Our Office</h3>
//                       <p className={`mt-1.5 leading-relaxed ${isDark ? "text-gray-300" : "text-gray-600"}`}>
//                         103, Goyal Vihar,<br />
...
//                   <div className="flex items-start gap-4">
//                     <div className={`p-3.5 rounded-xl ${isDark ? "bg-red-900/25 border border-red-800/40" : "bg-red-100 border border-red-200"}`}>
//                       <Phone className={`h-6 w-6 ${isDark ? "text-red-500" : "text-red-600"}`} />
//                     </div>
//                     <div>
//                       <h3 className={`text-lg font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>Phone</h3>
//                       <p className={`mt-1.5 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
...
//                   <div className="flex items-start gap-4">
//                     <div className={`p-3.5 rounded-xl ${isDark ? "bg-red-900/25 border border-red-800/40" : "bg-red-100 border border-red-200"}`}>
//                       <Mail className={`h-6 w-6 ${isDark ? "text-red-500" : "text-red-600"}`} />
//                     </div>
//                     <div>
//                       <h3 className={`text-lg font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>Email</h3>
//                       <p className={`mt-1.5 ${isDark ? "text-gray-300" : "text-gray-600"}`}>
//                         <a href="mailto:admin@atlaknots.com" className="hover:text-red-400 transition">admin@atlaknots.com</a>
//                       </p>
//                     </div>
//                   </div>
...
//                   <div className="flex items-start gap-4">
//                     <div className={`p-3.5 rounded-xl ${isDark ? "bg-red-900/25 border border-red-800/40" : "bg-red-100 border border-red-200"}`}>
//                       <Clock className={`h-6 w-6 ${isDark ? "text-red-500" : "text-red-600"}`} />
//                     </div>
//                     <div>
...
//                 >
//                   <h2 className={`text-2xl md:text-3xl font-bold mb-7 ${isDark ? "text-white" : "text-gray-900"}`}>
//                     Send Us a Message
//                   </h2>
