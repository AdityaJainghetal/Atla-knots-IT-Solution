...
import { motion } from "framer-motion";
import { 
  ArrowRight, Palette, Image as ImageIcon, Video, 
...
const images = {
  ...
  logoProcess: "https://images.unsplash.com/photo-1581287053822-fd7bf4f1afec?auto=format&fit=crop&w=2340&q=80",
  socialGraphics: "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=2340&q=80",
  videoEdit: "https://images.unsplash.com/photo-1611162617210-7d7a39e9b1d7?auto=format&fit=crop&w=2340&q=80",
};
...
const faqs = [
  {
    q: "What graphic design services does Atla Knots IT Solutions provide?",
...
export default function GraphicDesigning() {
  ...
  return (
    <div className={`min-h-screen overflow-hidden transition-colors duration-700 ${isDark ? "bg-black text-white" : "bg-white text-gray-900"}`}>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={images.hero}
            alt="Creative Graphic Design Services in Bhopal - Atla Knots"
            className="w-full h-full object-cover brightness-50"
            loading="eager"
          />
          <div className={`absolute inset-0 bg-gradient-to-br ${isDark ? "from-black/90 via-black/80 to-black/90" : "from-black/70 via-black/60 to-transparent"}`} />
        </div>
        ...
        >
          ...
          >
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-white">Bhopal</span>
          </motion.h1>
          ...
          >
            At <span className="font-semibold text-red-400">Atla Knots IT Solutions</span>, we create stunning logos, social media graphics, 
            and videos that help your business look professional and grow faster.
          </motion.p>

          <motion.div variants={{ hidden: { opacity: 0, y: 40 }, visible: { opacity: 1, y: 0 } }} className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button className={`px-12 py-6 border-2 border-red-500 rounded-full text-xl font-bold transition-all ${isDark ? "text-red-400 hover:bg-red-950/60" : "text-red-600 hover:bg-red-50"}`}>
              View Our Work →
            </button>
          </motion.div>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, idx) => (
              ...
              >
                <service.icon className={`w-20 h-20 mx-auto mb-8 transition-transform group-hover:scale-110 ${accentClass}`} />
                <h3 className={`text-2xl font-bold mb-6 ${headingClass}`}>{service.title}</h3>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className={`text-xl mb-10 ${bodyClass}`}>
              Good design is not just about looking pretty — it's about making your business memorable and trustworthy.
            </p>
            <ul className="space-y-6 text-lg">
              {whyImportant.map((point, i) => (
                <li key={i} className="flex items-start gap-4">
                  <CheckCircle className={`w-8 h-8 mt-1 flex-shrink-0 ${accentClass}`} />
                  <span className={bodyClass}>{point}</span>
                </li>
              ))}
            </ul>
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-gray-950" : "bg-gray-50"}`}>
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            className={`text-4xl md:text-6xl font-black text-center mb-16 ${headingClass}`}
          >
            Why Choose <span className={accentClass}>Atla Knots</span> for Graphic Design?
          </motion.h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChoose.map((reason, idx) => (
              ...
              >
                <div className={`text-6xl font-black ${accentClass} mb-6 opacity-75`}>{`0${idx + 1}`}</div>
                <p className={`text-lg leading-relaxed ${bodyClass}`}>{reason}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Let’s Create Designs That Make Your Brand <span className={accentClass}>Stand Out</span>
          </motion.h2>

          <motion.p className={`text-xl max-w-3xl mx-auto mb-12 ${bodyClass}`}>
            From logos to social media creatives and video editing — we deliver designs that help your business grow in Bhopal and beyond.
          </motion.p>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  <span className={`text-xl font-semibold ${headingClass}`}>{faq.q}</span>
                  <ChevronDown className={`w-6 h-6 text-red-500 transition-transform duration-300 ${openFaq === idx ? "rotate-180" : ""}`} />
                </button>
