...
//             <div>
//               <motion.h2 initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-4xl md:text-5xl font-black mb-8">
//                 Why Choose <span className="text-red-500">Atla Knots</span>
//               </motion.h2>
...
export default function WebsiteDesignDevelopment() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-700 overflow-hidden
      ...
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-black/40" : "bg-gray-100"}`}>
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className={`mt-6 text-xl ${bodyClass}`}>
            Fully responsive across desktop, tablet, and mobile – essential for 2026 traffic.
          </p>
        </div>
      </section>
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "" : "bg-white"}`}>
        <div className="max-w-7xl mx-auto">
          <motion.h2 initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className={`text-4xl md:text-6xl font-black text-center mb-16 ${headingClass}`}>
            Why Your Business Needs a <span className={accentClass}>Modern Website</span>
          </motion.h2>

          <motion.p initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className={`text-xl mb-12 max-w-4xl mx-auto text-center ${bodyClass}`}>
            In 2026, your website is your 24/7 salesperson. Outdated or slow sites lose customers to competitors instantly.
          </motion.p>
            ...
            {benefits.map((benefit, idx) => (
              ...
              >
                <div className="flex items-center">
                  <CheckCircle2 className={`w-8 h-8 ${accentClass} mr-4 flex-shrink-0`} />
          ...
          <div className="grid md:grid-cols-5 gap-6">
            {processSteps.map((step, idx) => (
              <motion.div
                ...
                className={cardClass}
              >
                <div className={`text-3xl font-black ${accentClass} mb-2`}>{idx + 1}</div>
      ...
      {/* CTA Example Visual */}
      <section className={`py-16 px-4 sm:px-6 lg:px-8 ${isDark ? "" : "bg-white"}`}>
        <div className="max-w-5xl mx-auto text-center">
          <motion.h3 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className={`text-3xl font-bold mb-8 ${headingClass}`}>
            Conversion-Focused Design in Action
          </motion.h3>
          <motion.img 
            src={images.ctaExample} 
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-gradient-to-b from-black to-gray-950" : "bg-gray-50"}`}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <motion.h2 initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className={`text-4xl md:text-5xl font-black mb-8 ${headingClass}`}>
            ...
            <div>
              <motion.h2 initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className={`text-4xl md:text-5xl font-black mb-8 ${headingClass}`}>
                Why Choose <span className={accentClass}>Atla Knots</span>
              </motion.h2>
              <div className="grid gap-6">
                {whyChoose.map((point, idx) => (
                  <motion.div
      ...
      <section className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-gradient-to-br from-red-950/30 to-black" : "bg-red-50"}`}>
        <div className="max-w-5xl mx-auto text-center">
          <motion.h2 initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className={`text-4xl md:text-6xl font-black mb-8 ${headingClass}`}>
            Ready to Build Your <span className={accentClass}>High-Performing</span> Website?
          </motion.h2>
