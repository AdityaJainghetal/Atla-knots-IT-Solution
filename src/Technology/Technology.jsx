  ...
  return (
    <div className={`min-h-screen overflow-x-hidden relative transition-colors duration-700
      ...
      <section className={`py-24 relative overflow-hidden
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className={`text-4xl md:text-5xl font-bold mb-4 ${headingClass}`}>Our Core Services</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-600 to-red-800 mx-auto mb-6"></div>
            <p className={`text-lg max-w-2xl mx-auto ${bodyClass}`}>From ideation to 24/7 support — we deliver end-to-end excellence.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
            {[
              { title: "Application & Website Development", icon: Code2, items: [
              ...
              { title: "Testing & Quality Assurance", icon: Search, items: [
              ...
              { title: "Digital Marketing & E-commerce Solutions", icon: ShoppingCart, items: [
              ...
              { title: "Production Support & Maintenance", icon: Wrench, items: [
              ...
              { title: "BPO & IT Staffing Solutions", icon: Wrench, items: [
              ...
              const ServiceIcon = service.icon;
              return (
                <div key={service.title} className={`group relative rounded-2xl p-8 border transition-all duration-500 hover:-translate-y-2 animate-slide-up overflow-hidden ${cardClass}`} style={{ animationDelay: `${idx * 150}ms` }}>
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-red-600 to-red-700 rounded-xl flex items-center justify-center mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg shadow-red-600/30">
                      <ServiceIcon className="w-8 h-8 text-white" />
                    </div>
                    ...
                    <ul className="space-y-4">
                      {service.items.map((item, itemIdx) => {
                        const ItemIcon = item.icon || CheckCircle2;
                        return (
                          <li key={item.text} className={`flex items-start gap-3 ${bodyClass} hover:translate-x-2 transition-all duration-300`}>
                            <ItemIcon className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                            <span>{item.text}</span>
                          </li>
                        );
              ...
              return (
                <div key={tech.name} className={`group relative rounded-xl p-6 text-center font-semibold border transition-all duration-300 hover:scale-110 cursor-pointer ${cardClass}`}>
                  <div className="relative z-10 flex flex-col items-center gap-3">
                    ...
                    <div className={`group-hover:text-white transition-colors text-sm ${bodyClass}`}>{tech.name}</div>
                  </div>
                </div>
              );
            })}
      ...
      <section className={`py-24 relative overflow-hidden
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className={`text-4xl md:text-5xl font-bold mb-4 ${headingClass}`}>Industry-Specific Solutions</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-red-600 to-red-800 mx-auto"></div>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {[
              { title: "Banking & Financial Services", icon: Landmark, items: [
              ...
              { title: "Retail & E-Commerce", icon: ShoppingCart, items: [
              ...
              { title: "Enterprise Solutions", icon: Building, items: [
              ...
              { title: "Government & PSU Projects", icon: Landmark, items: [
              ...
              const DomainIcon = domain.icon;
              return (
                <div key={domain.title} className={`group relative rounded-2xl overflow-hidden border transition-all duration-500 hover:-translate-y-2 ${cardClass}`}>
                  <div className="relative h-48 bg-gradient-to-br from-red-600 to-red-800 flex flex-col items-center justify-center text-white p-8 overflow-hidden">
                    <DomainIcon className="w-12 h-12 text-white mb-4" />
                  ...
                  <div className="p-8">
                    <ul className="space-y-4">
                      {domain.items.map((item, i) => {
                        const ItemIcon = item.icon;
                        return (
                          <li key={i} className={`flex items-start gap-3 ${bodyClass}`}>
                            <ItemIcon className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                            <span>{item.text}</span>
                          </li>
                        );
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 z-50 p-4 rounded-full bg-gradient-to-r from-red-600 to-red-700 text-white shadow-xl shadow-red-900/40 transition-all duration-400 hover:scale-110 active:scale-95
